...
export default function DigitalNomadJourneyAnimation() {
  ...
  return (
    <div 
      ref={containerRef} 
      className="w-full h-full relative p-8 bg-white rounded-xl shadow-xl overflow-hidden"
      style={{ position: 'relative' }} // Fix for the position warning
    >
      {/* McLaren-style background elements */}
      <div className="absolute top-0 left-0 w-4 h-full bg-[#FF8000]"></div>
      <div className="absolute bottom-0 left-0 w-full h-4 bg-[#0090D4]"></div>
      ...
      {/* Progress line */}
      <motion.div 
        className="absolute top-1/2 left-0 h-2 bg-gradient-to-r from-[#FF8000] to-[#0090D4] rounded-full"
        style={{ 
          width: `${progress}%`,
          zIndex: 1
        }}
      >
        {/* Racing pulse effect */}
        <motion.div
          className="absolute right-0 top-1/2 w-4 h-4 rounded-full bg-white border-2 border-[#FF8000] transform -translate-y-1/2"
          animate={{ 
            boxShadow: ['0 0 0 0 rgba(255, 128, 0, 0.4)', '0 0 0 10px rgba(255, 128, 0, 0)', '0 0 0 0 rgba(255, 128, 0, 0)'],
          }}
          transition={{ 
            repeat: Infinity, 
            duration: 1.5 
      ...
      <div className="absolute bottom-36 left-0 w-full">
        <div className="relative h-40">
          ...
          >
            <div className="flex flex-col items-center">
              <div className="mb-2 p-3 bg-gray-100 rounded-full">
                <Laptop className="w-8 h-8 text-[#FF8000]" />
              </div>
            ...
            <div className="flex flex-col items-center">
              <div className="relative">
                ...
                <div className="absolute -top-14 left-1/2 transform -translate-x-1/2">
                  <div className="w-10 h-10 bg-[#0F172A] rounded-full"></div>
                  <div className="w-6 h-12 bg-[#FF8000] absolute left-2 top-8"></div>
                </div>
                
                {/* Bicycle */}
                <div className="mb-2 p-2 bg-white rounded-full border-2 border-[#0090D4]">
                  <Bike className="w-8 h-8 text-[#0090D4]" />
                </div>
                
                {/* Briefcase */}
                <div className="absolute -right-5 top-0">
                  <Package className="w-6 h-6 text-[#1E293B]" />
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="flex flex-col items-center">
              <div className="relative">
                <div className="w-40 h-30 bg-gray-100 rounded-lg border-t-4 border-[#0090D4]"></div>
                <div className="absolute top-5 left-1/2 transform -translate-x-1/2">
                  <Laptop className="w-8 h-8 text-[#0090D4]" />
                </div>
                <div className="absolute top-5 left-5">
                  <Code className="w-6 h-6 text-[#FF8000]" />
                </div>
                <div className="absolute top-5 right-5">
                  <Server className="w-6 h-6 text-[#FF8000]" />
                </div>
              </div>
            </div>
          </motion.div>
              ...
              <div className="relative">
                <div className="flex space-x-3">
                  <div className="p-2 bg-gray-100 rounded-lg">
                    <Smartphone className="w-6 h-6 text-[#0090D4]" />
                  </div>
                  <div className="p-2 bg-gray-100 rounded-lg">
                    <Laptop className="w-6 h-6 text-[#0090D4]" />
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="flex flex-col items-center">
                  <div className="w-40 h-20 bg-gray-100 rounded-lg relative overflow-hidden">
                    ...
                    <div className="absolute left-2 top-1/2 transform -translate-y-1/2">
                      <Server className="w-6 h-6 text-[#0090D4]" />
                    </div>
                    ...
                    >
                      <div className="flex space-x-1">
                        ...
                        <div className="w-2 h-2 rounded-full bg-[#0090D4]"></div>
                        <div className="w-2 h-2 rounded-full bg-[#FF8000]"></div>
                      </div>
                    </motion.div>
                    ...
                    <div className="absolute right-2 top-1/2 transform -translate-y-1/2">
                      <Globe className="w-6 h-6 text-[#FF8000]" />
                    </div>
                  </div>
                  ...
                  <div className="mt-2 text-center">
                    <motion.div 
                      className="text-sm font-medium text-[#FF8000]"
                      animate={{ 
                  ...
                  >
                    <Send className="w-4 h-4 text-[#0090D4]" />
                    <Package className="w-4 h-4 text-[#FF8000]" />
                    <MapPin className="w-4 h-4 text-[#0090D4]" />
                  </motion.div>
                </div>
              </div>
            </div>
      ...
      <div className="absolute top-20 left-1/2 transform -translate-x-1/2">
        ...
        >
          ...
          {/* PlayStore */}
          <motion.div 
            className="absolute p-2 bg-green-500 rounded-full text-white"
            style={{ 
              top: '0%',
              left: '50%',
              transform: 'translateX(-50%)'
          ...
          {/* Web */}
          <motion.div 
            className="absolute p-2 bg-[#0090D4] rounded-full text-white"
            style={{ 
              top: '50%',
              right: '0%',
          ...
          {/* Mobile */}
          <motion.div 
            className="absolute p-2 bg-[#FF8000] rounded-full text-white"
            style={{ 
              bottom: '0%',
              left: '50%',
              transform: 'translateX(-50%)'
          ...
          {/* Social Media */}
          <motion.div 
            className="absolute p-2 bg-blue-600 rounded-full text-white"
            style={{ 
              top: '50%',
              left: '0%',
              transform: 'translateY(-50%)'
